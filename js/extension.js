  ...
  if (data.filedeleted) {
    ...
    if (data.spoiler) {
      if (!Config.revealSpoilers) {
        ...
        fileThumb = '//s.localhost/image/spoiler'
    ...
    if (!fileThumb) {
      fileThumb = '//i.localhost/' + board + '/' + data.tim + 's.jpg';
    }
  ...
  if (file = $.id('fT' + pid)) {
    ...
    if (el) {
      if (/(gif|jpg|png)$/.test(el.href)) {
        ...
        href = 'http://i.localhost/' + Main.board + '/'
...
var Search = {
  ...
  init: function() {
    ...
    if (el = $.id('g-search-form')) {
      ...
      if (location.host == 'boards.localhost') {
        Search.initSelector();
      }
...
ImageExpansion.loadOgv = function(target) {
  ...
  s.src = 'https://s.localhost/js/ogv/ogv.js';
...
ImageExpansion.expandWebm = function(thumb) {
  ...
  if (href.match(/\.webm$/) && /iPhone|iPad/.test(navigator.userAgent)) {
    ...
    el.src = href.replace(/\/\/.+\.4chan\.org\//, '//i.localhost/');
    OgvCtrl.attach(el);
...
QR.onOpenInPainterClick = function(btn) {
  ...
  img.src = el.href.replace('is2.localhost', 'i.localhost');
...
ThreadUpdater.init = function() {
  ...
  this.iconPath = '//s.localhost/image/';
  ...
  if (Config.updaterSound) {
    ...
    this.audio.src = '//s.localhost/media/beep.ogg';
  }
...
SWFEmbed.getFrameNode = function(file_url, width, height) {
  ...
  el.src = `//s.localhost/media/flash/embed.html?4#${+width},${+height},${filename},1`;
...
Main.init = function() {
  ...
  Main.is_4channel = location.host === 'boards.localhost';
...
.m-dark .button {\
  ...
  background-image: url("//s.localhost/image/buttonfade-dark.png");\
...
.m-dark #globalToggle {\
  ...
  background-image: url("//s.localhost/image/buttonfade-red.png");\
